...
const AboutUs = () => {
  return (
    <div
      className="bg-white max-w-7xl mx-auto px-6 lg:px-8 shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105"
    ...
    >
      ...
      <div className="flex items-center justify-start pl-8 h-full">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold text-custom-purple">About Us</h1>
          ...
          <button className="px-6 py-3 bg-custom-purple text-white rounded-full hover:bg-blue-600 transition duration-300 ease-in-out relative top-5">
            Explore Properties
          </button>
        </div>
      </div>
