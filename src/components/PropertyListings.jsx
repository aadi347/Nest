          ...
          {listings.map((listing) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mb-2">
                <span className="text-2xl font-semibold text-custom-purple">${listing.rent}</span>
              ...
              <div className="mt-4 flex items-center space-x-4 text-gray-600">
                ...
                <div className="flex items-center">
                  <svg className="h-5 w-5 text-custom-purple mr-1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button className="mt-4 bg-custom-purple text-white px-4 py-2 rounded-lg font-medium hover:bg-indigo-500 transition duration-200 ease-in-out">
                More Detail
              </button>
            </div>
          ))}
