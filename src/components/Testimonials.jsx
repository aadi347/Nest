...
import BackgroundImage from "../assets/icons/abstract.png"
  ...
  return (
    ...
    backgroundRepeat: 'no-repeat'
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <h2 className="text-3xl font-extrabold text-center text-gray-800 sm:text-4xl">What Our Clients Say</h2>
