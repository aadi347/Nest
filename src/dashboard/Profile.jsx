...
const Profile = () => {
  ...
  return (
    ...
    <img src="https://img.freepik.com/free-vector/stunning-mountain-background-thrill-climbing-high-peaks_1017-53884.jpg" alt="cover-image" className="w-full absolute top-0 left-0 rounded-lg z-0 h-60 object-cover" />
    <div className="w-full max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex max-sm:flex-wrap max-sm:justify-center items-center gap-4">
            <a href="javascript:;" className="rounded-full py-3 px-6 bg-stone-100 text-gray-700 font-semibold text-sm leading-6 transition-all duration-500 hover:bg-stone-200 hover:text-gray-900">Ux Research</a>
            <a href="javascript:;" className="rounded-full py-3 px-6 bg-stone-100 text-gray-700 font-semibold text-sm leading-6 transition-all duration-500 hover:bg-stone-200 hover:text-gray-900">CX Strategy</a>
            <a href="javascript:;" className="rounded-full py-3 px-6 bg-stone-100 text-gray-700 font-semibold text-sm leading-6 transition-all duration-500 hover:bg-stone-200 hover:text-gray-900">Project Manager</a>
        </div>
    </div>
</section>
