...
const Profile = () => {
  ...
  const [bio, setBio] = useState("Web developer passionate about React and Tailwind.");
  ...
  return (
    ...
    <img src="https://wallpaperboat.com/wp-content/uploads/2019/10/free-mountain-vector-01.jpg" alt="cover-image" className="w-full  absolute top-0 left-0 rounded-3xl shadow-2xl z-0 h-60 object-cover" />
    <div className="w-full max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex items-center justify-center flex-col sm:flex-row max-sm:gap-5 sm:justify-between mb-5">
            <div className="block">
                <h3 className="font-manrope font-bold text-4xl text-gray-900 mb-1 max-sm:text-center">Aditya Kumar</h3>
                <p className="font-normal text-base leading-7 text-gray-500  max-sm:text-center">Founder, Nest <br className="hidden sm:block" />Patna
                    Bihar, India</p>
            </div>
            <button
        ...
        <div className="flex max-sm:flex-wrap max-sm:justify-center items-center gap-4">
            <a href="javascript:;" className="rounded-full py-3 px-6 bg-stone-100 text-gray-700 font-semibold text-sm leading-6 transition-all duration-500 hover:bg-stone-200 hover:text-gray-900">Frontend</a>
            <a href="javascript:;" className="rounded-full py-3 px-6 bg-stone-100 text-gray-700 font-semibold text-sm leading-6 transition-all duration-500 hover:bg-stone-200 hover:text-gray-900">Backend</a>
            <a href="javascript:;" className="rounded-full py-3 px-6 bg-stone-100 text-gray-700 font-semibold text-sm leading-6 transition-all duration-500 hover:bg-stone-200 hover:text-gray-900">Prisma</a>
        </div>
    </div>
</section>
